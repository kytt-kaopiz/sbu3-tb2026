      ...
      <div style={{background:"linear-gradient(180deg,#071E30 0%,#0A2E48 100%)",padding:"80px 32px"}}>
        <div style={{maxWidth:1040,margin:"0 auto"}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"2fr 1fr 1fr",gap:12,borderRadius:16,overflow:"hidden"}}>
            ...
            <div style={{borderRadius:16,overflow:"hidden",boxShadow:"0 4px 20px rgba(0,0,0,0.35)"}}>
            ...
            <div style={{gridColumn:"2 / span 2",overflow:"hidden",borderRadius:12,height:180}}>
              <div style={{width:"100%",height:"100%",background:"linear-gradient(135deg,#0E5A8A,#0B3D5E)",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:8}}>
                <div style={{fontFamily:"Calibri,Candara,Segoe,Segoe UI,Optima,Arial,sans-serif",fontWeight:900,fontSize:36,color:"#FFB800",textAlign:"center"}}>SBU3 YEAR-END 2025</div>
                <div style={{fontSize:13,color:"rgba(255,248,238,0.6)",textAlign:"center",letterSpacing:"0.2em"}}>CÙNG NHAU — MẠNH HƠN</div>
              </div>
            </div>
          </div>
            <div style={{borderRadius:16,background:"linear-gradient(135deg,#0D3A5C,#071E30)",
              border:"1px solid rgba(77,208,225,0.2)",display:"flex",flexDirection:"column",
              alignItems:"center",justifyContent:"center",gap:12,padding:24,
              boxShadow:"0 4px 20px rgba(0,0,0,0.35)"}}>
              <div style={{fontSize:40}}>⚡</div>
              <div style={{fontFamily:"Calibri,Candara,Segoe,Segoe UI,Optima,Arial,sans-serif",fontWeight:900,fontSize:28,color:"#FFB800",textAlign:"center",lineHeight:1.1}}>SBU3<br/>YEAR-END<br/>2025</div>
              <div style={{fontSize:11,color:"rgba(255,248,238,0.45)",textAlign:"center",letterSpacing:"0.2em",textTransform:"uppercase"}}>Cùng nhau · Mạnh hơn</div>
            </div>
          </div>
        </div>
      </div>
